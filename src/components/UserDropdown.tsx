      ...
      <div className="relative px-5 py-5 sm:py-0 sm:ml-4 sm:px-0">
        ...
        <div className="hidden sm:block">
          <div className="relative">
            <button type="button" onClick={this.props.action} className="block focus:outline-none">
              <span
            ...
            <div className={`${this.props.open ? "block" : "hidden"}`}>
              <button type="button" onClick={this.props.action} className="z-30 block fixed inset-0 w-full h-full cursor-default"></button>
              <div className="absolute z-40 right-0">
                <div className={`mt-3 bg-white xl:border rounded-lg w-48 py-2 shadow-xl ${this.props.open ? "block" : "hidden"}`}>
